...
func (c *streamServiceClient) FetchResponse(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_FetchResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/grpc_steaming.StreamService/FetchResponse", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamServiceFetchResponseClient) Recv() (*Result, error) {
	m := new(Result)
...
func (x *streamServiceFetchResponseServer) Send(m *Result) error {
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_steaming.StreamService",
